        ...
        <div className="flex flex-wrap justify-center gap-4">
          {gameState.board.map((cat, i) => (
            ...
            >
              <GlassPanel
                glow
                glowColor="oklch(0.55 0.25 265 / 0.3)"
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-8 p-8">
        ...
        {gameState.currentClueQuestion && (
          <GlassPanel glow glowColor="oklch(0.55 0.25 265 / 0.25)" className="max-w-4xl px-12 py-8">
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-8 p-8">
        ...
        <motion.div
          ...
          transition={{ delay: 0.5 }}
        >
          <GlassPanel glow glowColor="oklch(0.55 0.25 265 / 0.4)" className="px-16 py-10">
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-8 p-8">
        <h1
          ...
          style={{
            textShadow: "0 0 30px oklch(0.55 0.25 265 / 0.5)",
          }}
        >
          FINAL JEOPARDY
        </h1>
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-8 p-8">
        ...
        {gameState.finalJeopardyQuestion && (
          <GlassPanel glow glowColor="oklch(0.55 0.25 265 / 0.3)" className="max-w-4xl px-12 py-8">
            <p className="text-center font-body text-[clamp(28px,3.5vw,48px)] leading-snug text-text-primary">
              {gameState.finalJeopardyQuestion}
            </p>
          </GlassPanel>
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-6 p-8">
        <h1
          ...
          style={{ textShadow: "0 0 24px oklch(0.55 0.25 265 / 0.5)" }}
        >
          FINAL JEOPARDY REVEAL
        </h1>
