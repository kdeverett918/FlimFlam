                  ...
                  <motion.div
                    ...
                    className={`flex items-center justify-center rounded-md border-2 ${
                      isBlank
                        ...
                        : isHighlighted
                          ? "border-accent-luckyletters bg-accent-luckyletters/30"
                          : "border-accent-luckyletters/50 bg-bg-elevated"
                    }`}
                    style={{
...
interface LuckyLettersHostProps {
  phase: string;
  round: number;
  totalRounds: number;
  players: PlayerData[];
        ...
        return (
          <div
            ...
            className={`flex items-center gap-2 rounded-xl px-4 py-2 transition-all ${
              isCurrent ? "bg-accent-luckyletters/15 border border-accent-luckyletters/30" : ""
            }`}
          >
            ...
            {lastSpin && !isSpinning && (
              <span
                className={`font-display text-[clamp(24px,3vw,36px)] font-bold ${
                  lastSpin.segment.type === "bust"
                    ? "text-accent-6"
                    : lastSpin.segment.type === "pass"
                      ? "text-warning"
                      : lastSpin.segment.type === "wild"
                        ? "text-success"
                        : "text-accent-luckyletters"
                }`}
              >
