        ...
        <div className="flex justify-center gap-3">
          {codeChars.map((char, index) => (
            <input
              ...
              className="glass-input h-14 w-12 rounded-xl text-center font-mono text-2xl font-bold text-text-primary uppercase transition-all focus:border-primary/60 focus:shadow-[0_0_16px_oklch(0.75_0.22_25_/_0.25)] disabled:opacity-50 sm:h-16 sm:w-14"
              style={{
