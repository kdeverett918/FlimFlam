  ...
  if (!expanded) {
    return (
      ...
      >
        ...
        <span className="font-display text-sm font-semibold text-accent-4">{roleName}</span>
        <ChevronDown className="ml-auto h-4 w-4 text-text-primary" />
      </button>
    );
  }
  ...
  return (
    ...
    >
      ...
      <button
        ...
        onClick={handleToggle}
        aria-expanded={true}
        className="flex w-full items-center gap-3 border-b border-white/[0.12] px-4 py-3"
      >
