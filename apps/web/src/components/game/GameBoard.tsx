...
export function GameBoard({
  ...
  const contentLayoutClass = wideRailOnWideScreens
    ...
    : "mx-auto flex min-h-full w-full max-w-[1640px] flex-col gap-4 px-3 pb-4 pt-3 sm:gap-5 sm:px-4 sm:pb-5 sm:pt-4 lg:gap-6 lg:px-6";
  const boardSurfaceClass = wideRailOnWideScreens
    ...
    : "relative flex min-h-[min(30svh,18rem)] flex-1 overflow-hidden rounded-[28px] border border-white/12 bg-[radial-gradient(circle_at_top,oklch(0.18_0.05_255/0.72),transparent_42%),linear-gradient(180deg,oklch(0.12_0.025_252/0.94),oklch(0.08_0.018_248/0.98))] shadow-[0_30px_120px_oklch(0_0_0/0.38)] ring-1 ring-white/5";
  const controlsShellClass = wideRailOnWideScreens
    ...
    : "relative mx-auto w-full max-w-6xl overflow-hidden rounded-[26px] border border-white/12 bg-[linear-gradient(180deg,oklch(0.14_0.03_252/0.9),oklch(0.09_0.02_248/0.96))] shadow-[0_24px_80px_oklch(0_0_0/0.3)] ring-1 ring-white/6 backdrop-blur-2xl";
